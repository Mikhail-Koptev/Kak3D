...
<html lang="ru-RU">
	...
	<title>Войти &lsaquo; Какая-то штучка &#8212; WordPress</title>
		...
		<form name="loginform" id="loginform" action="http://localhost/wordpress/wp-login.php" method="post">
			...
			<p class="submit">
				<input type="submit" name="wp-submit" id="wp-submit" class="button button-primary button-large" value="Войти">
					...
					<p id="nav">
				<a href="./?action=lostpassword">Забыли пароль?</a>			</p>
...
if ( typeof wpOnload === 'function' ) { wpOnload() }</script>
				<p id="backtoblog">
			<a href="./index.html">&larr; Перейти к Какая-то штучка</a>		</p>
			</div>
...
<option value="ru_RU" lang="ru" selected data-installed="1">Русский</option></select>
...
<script id="user-profile-js-extra">var userProfileL10n = {"user_id":"0","nonce":"ff3e0b8895"};</script>
